...
import com.stock.authapi.helper.UserTestDataFactory;
import com.stock.authapi.helper.Util;
...
import static com.stock.authapi.helper.Util.fromJson;
...
class AuthControllerTest {
    ...
    public void testLoginSuccess() throws Exception {
        ...
        MvcResult createResult = this.mockMvc
                .perform(post("/v1.0/auth/login")
                        ...
                        .content(Util.toJson(objectMapper, request)))
                .andExpect(status().isOk())
                .andExpect(header().exists(HttpHeaders.AUTHORIZATION))
                .andReturn();

        UserView authUserView = Util.fromJson(objectMapper, createResult.getResponse().getContentAsString(), UserView.class);
    ...
    public void testRegisterSuccess() throws Exception {
        ...
        MvcResult createResult = this.mockMvc
                .perform(post("/v1.0/auth/register")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(Util.toJson(objectMapper, goodRequest)))
                .andExpect(status().isOk())
                .andReturn();

        UserView userView = Util.fromJson(objectMapper, createResult.getResponse().getContentAsString(), UserView.class);
    ...
    public void testRegisterFail() throws Exception {
        ...
        this.mockMvc
                .perform(post("/v1.0/auth/register")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(Util.toJson(objectMapper, badRequest)))
