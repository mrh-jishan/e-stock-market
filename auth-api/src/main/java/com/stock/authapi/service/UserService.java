package com.stock.authapi.service;


import com.stock.authapi.dto.*;
import com.stock.authapi.mapper.UserEditMapper;
...
public class UserService implements UserDetailsService {
    ...
    public UserView delete(ObjectId id) {
        ...
        user.setUsername(String.format("%s_%s", user.getUsername(), user.getId()));
